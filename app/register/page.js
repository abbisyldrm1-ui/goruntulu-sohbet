  ...
  return (
    <main style={styles.page}>
      <div style={styles.wrap}>
        ...
        <h1 style={styles.aura}>AURA</h1>
        <h2 style={styles.live}>LIVE</h2>

        <div style={styles.line}>◇</div>

        <p style={styles.premium}>PREMİUM GÖRÜNTÜLÜ SOHBET</p>
        ...
        <button style={styles.button} onClick={kayitOl}>
          Kayıt Ol
        </button>
...
const styles = {
  ...
  button: {
    ...
    borderRadius: "14px",
    border: "none",
    background: "linear-gradient(180deg, #ffe36b, #ffc400, #d99000)",
    color: "black",
    fontSize: "30px",
    fontWeight: "900",
    cursor: "pointer",
    boxShadow: "0 0 30px rgba(255,194,0,0.55)",
  },
